	...
	<div class="box">
		<div class="container">
			...
			<el-form :model="data" :rules="rules" ref="data" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
				...
				<el-form-item label="尺寸模型">
					<el-switch style="display: block" v-model="data.model" active-color="#13ce66" inactive-color="#ff4949" active-text="是" inactive-text="否">
					</el-switch>
...
<script>
	import { AddSizeType } from 'api/sizeType'
