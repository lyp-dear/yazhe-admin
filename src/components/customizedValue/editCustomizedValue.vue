		...
		<div class="container">
			...
			<el-form :model="data" :rules="rules" ref="data" label-width="100px" class="demo-ruleForm" :label-position="labelPosition">
				<el-form-item label="定制类型值名称" prop="name">
					<el-input v-model="data.name" placeholder="请填写尺寸值名称"></el-input>
				</el-form-item>
...
<script>
	import { CustomizedList ,AddCustomizedValue,UpdateCustomizedValue} from 'api/customized'
	...
	export default {
		...
		methods: {
			getData() {
				...
				this.data.customized_id = this.$route.params.customized_id;
				console.log(this.data.customized_id)
